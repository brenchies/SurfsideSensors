...
class TinyGSMWrapper{
    public:
    int status = 0;
    String deviceName = "sim";
    String errorBuffer = "";
    String dateTime = "2022";
    void getTime(){
    ...
    TinyGSMWrapper(const char* apn, const char* gprsuser=,\
     const char* gprspass=, const char* server, const char* , uart_baud=115200, long pin_dtr=25, long pin_tx = 27, long pin_rx=26, long pin_pwr=4)
    {
        UART_BAUD = uart_baud;
        PIN_DTR = pin_dtr;
