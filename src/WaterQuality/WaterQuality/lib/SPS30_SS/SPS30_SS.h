...
class SPS30_S : public sensorBase, public SPS30
{
public:
    enum Sensors
    {
    ...
    SPS30_S(int enablepin, String sensorname[], String unit[], int numberOfSamples = 10, long sampleRead_delay = 50, int decimals = 3):SHT31()
    {
        ENABLEPIN = enablepin;
